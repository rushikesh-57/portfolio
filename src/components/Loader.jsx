  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        .loader .path-6 { animation-delay: -.875s }
        .loader .path-5 { animation-delay: -.75s }
        .loader .path-4 { animation-delay: -.625s }
        .loader .path-3 { animation-delay: -.5s }
        .loader .path-2 { animation-delay: -.375s }
        .loader .path-1 { animation-delay: -.25s }
        .loader .path-0 { animation-delay: -.125s }
